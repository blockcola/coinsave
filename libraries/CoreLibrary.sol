...
library CoreLibrary {
    ...
    struct ReserveData {
        ...
        **/
        ...
        uint256 decimals;
        /**
        * @dev address of the sToken representing the asset
        **/
    ...
    * @param _self the reserve object
    * @param _sTokenAddress the address of the overlying atoken contract
    ...
    **/
    function init(
        ...
        require(_self.sTokenAddress == address(0), "Reserve has already been initialized");
        ...
        _self.sTokenAddress = _sTokenAddress;
