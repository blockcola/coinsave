...
contract LendingPoolLiquidationManager is ReentrancyGuard, VersionedInitializable {
    ...
    **/
    function liquidationCall(
        ...
        SToken collateralAtoken = SToken(core.getReserveSTokenAddress(_collateral));

        //if liquidator reclaims the sToken, he receives the equivalent atoken amount
        if (_receiveSToken) {
    ...
    **/
    function calculateAvailableCollateralToLiquidate(
        ...
        vars.maxAmountCollateralToLiquidate = vars.maxAmountCollateralToLiquidate.mul(10 ** vars.collateralDecimals)
            .div(10 ** vars.principalDecimals);
        ...
        if (vars.maxAmountCollateralToLiquidate > _userCollateralBalance) {
            ...
            principalAmountNeeded = vars
                ...
                .div(10 ** vars.collateralDecimals)
